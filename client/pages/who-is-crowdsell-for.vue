	...
	#banner.essay-banner
		.container.tight.essay-container
			#banner-text.essay-text
				...
				p Crowdsell can be used for any creative work that exists primarily as information.

				p It's especially useful for anyone who doesn't want to create a pointless controlling company to make a living creating things in the common interest.
