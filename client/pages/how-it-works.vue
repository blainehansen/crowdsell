...
#how-it-works
	...
	.page-container
		...
		p
			| Visit&nbsp;
			nuxt-link(to="/who-is-crowdsell-for") the page about who and what Crowdsell is for
		...
		ul
			...
			li
				...
				nuxt-link(to="/why-is-crowdsell-different") visit the page about Crowdsell's differences from other crowdfunding systems.

			li
				| For a short period at the beginning of the campaign (called the "blind period"), no one, from the project creators to the operators of Crowdsell themselves, will know exactly how much the project has raised. To understand why we made this decision,&nbsp;
				nuxt-link(to="/why-is-crowdsell-different") visit the page about Crowdsell's differences from other crowdfunding systems.
